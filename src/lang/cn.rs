...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Checking...", "检测中..."),
        ("Required", "必填"),
        ("Multiple server config", "多服务器配置"),
        ("Auto switch server", "自动切换服务器"),
        ("Add server config", "添加服务器配置"),
        ("Edit server config", "编辑服务器配置"),
        ("Delete server config", "删除服务器配置"),
        ("Delete server config tip", "删除服务器配置 {name}？"),
        ("No server config", "暂无服务器配置"),
        ("Not checked", "未检测"),
        ("Check availability", "检测可用性"),
        ("ID Server Port", "ID 服务器端口"),
        ("Relay Server Port", "中继服务器端口"),
        ("Key", ""),
        ...
        ("Config name is required", "配置名称不能为空"),
        ("Config name cannot exceed 50 characters", "配置名称不能超过 50 个字符"),
        ("ID server address is required", "ID 服务器地址不能为空"),
        ("Server address is required", "服务器地址不能为空"),
        ("Invalid ID server port", "ID 服务器端口范围无效"),
        ("Invalid relay server port", "中继服务器端口范围无效"),
        ("Duplicate config name", "配置名称已存在"),
        ("This ID server address already exists", "该 ID 服务器配置已存在"),
        ("Maximum of 5 configs reached", "已达到最大配置数量（5 个）"),
        ("The last config cannot be deleted", "不能删除最后一个配置"),
        ("The default config cannot be deleted", "默认配置不允许删除"),
        ("The default config is pinned to the top", "默认配置固定置顶，不可调整优先级"),
        ("Invalid priority position", "优先级位置无效"),
        ("Config not found", "配置不存在"),
        ("The ID server is unreachable", "ID 服务器不可用"),
        ("Disconnect the remote session before switching config", "请先断开远程连接再切换配置"),
        ("Switching is protected, try again later", "切换保护中，请稍后重试"),
        ("Move up", "上移"),
        ("Move down", "下移"),
    ].iter().cloned().collect();
}

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Config name cannot exceed 50 characters", ""),
        ("ID server address is required", ""),
        ("Server address is required", ""),
        ("Invalid ID server port", ""),
        ("Invalid relay server port", ""),
        ("Duplicate config name", ""),
        ("This ID server address already exists", ""),
        ("Maximum of 5 configs reached", ""),
        ("The last config cannot be deleted", ""),
        ("The default config cannot be deleted", ""),
        ("The default config is pinned to the top", ""),
        ("Invalid priority position", ""),
        ("Config not found", ""),
        ("The ID server is unreachable", ""),
        ("Disconnect the remote session before switching config", ""),
